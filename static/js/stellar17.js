...
<html class="no-js " lang="en">
  <head>
    ...
    <meta property="og:description" content="@bguru: I really need help in replicating this site. Any tips suggestion and study materials or tutorial sites where should i start with? Point me in some direction. I need to build a multi-directional JQuery parallax page for a client - they basically want it to work in a similar way to this https://www.g-star.com/en_nl/raw/index.htm
...
I have the artwork ready and have found many jquery libraries that will allow me to scroll horiz/vertical - but i&#x27;m not sure how to combine both together at a specific co-ordinate. Could anyone please point me in a the right direction?"/>
    ...
    <meta property="twitter:description" content="@bguru: I really need help in replicating this site. Any tips suggestion and study materials or tutorial sites where should i start with? Point me in some direction. I need to build a multi-directi..."/>
...
.chat-messages[data-v-3b2f1a78] {
  ...
  <div class='chat-item__content'>
    ...
    <div class='chat-item__text js-chat-item-text'>
      hey I don&#39;t know if this is the right place to ask about this, but I signed up for an account with free stellar in 2015. I went now to recover it and the links all seem to be dead
                ...
                <div class="chat-item model-id-5a7e1c2c7084124a345a4095 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      when I got to <a href="https://launch.stellar.org/#/dashboard" rel="nofollow noopener noreferrer" target="_blank" class="link">https://launch.stellar.org/#/dashboard</a>
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c3c86ef1bb1418e12c9 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      <p>it gives me:<br>Your lumens will be sent to the following account:</p><p>Secret Key</p><p>Public Key:</p><p>Please copy your secret key NOW! After clicking &quot;Upgrade&quot; button below you will no longer be able to see your secret key and we WILL NOT be able to recover it. Protect your secret key—anyone who has it can access your account. </p>
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c4493be87284d9a0084 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      note that the secret and public keys are blank
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c52d74ee9f50da5c131 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      also, I&#39;m having a hard time figuring out how to connect to the mainnet
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c65b3c4a0d37602f516 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      I was able to follow the instructions to set up an account on the testnet, but haven&#39;t been able to find mainnet instructions
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c6f4a6b0dd32bafbf68 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      I assume I&#39;m supposed to use the credentials that are in my account
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e1c724a6b0dd32bafbf7c burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      which are blank
                ...
                <div class="chat-item model-id-5a7e1c887084124a345a4236 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
  <div class='chat-item__content'>
    <div class='chat-item__text js-chat-item-text'>
      to further complicate things, I signed up with an email account on a domain that I am no longer paying for
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5a7e205718f388e626840f76 burstStart read  " role="listitem"><div class='chat-item__container'>
  <div class='chat-item__aside'>
    <div class="chat-item__avatar">
      <div
  class="trpDisplayPicture avatar-5a7e1bc3d73408ce4f8c7b64 avatar-s offline  ">
  ...
  <div class='chat-item__content'>
    <div class='chat-item__details'>
      <div class='chat-item__from js-chat-item-from'>Max</div>
      <div class='chat-item__username js-chat-item-from'>@cowpig</div>
      <a class='chat-item__time js-chat-time'  href='static/js/stellar22.js' title=""></a>
    </div>
    <div class='chat-item__text js-chat-item-text'>
      I do have a &quot;recovery token&quot; from 2015
    </div>
  </div>
</div>
</div>
                <div class="chat-item model-id-5d4417573d8f1f29e0fab2bc burstStart read  " role="listitem"><div class='chat-item__container'>
  <div class='chat-item__aside'>
    <div class="chat-item__avatar">
      <div
  class="trpDisplayPicture avatar-5d441736d73408ce4fc792be avatar-s offline  ">
  <img src="https://avatars2.githubusercontent.com/u/53261581?v=4&amp;s=30" srcset="https://avatars2.githubusercontent.com/u/53261581?v=4&amp;s=60 2x" height="30" width="30" class="avatar__image" alt="">
  ...
  <div class='chat-item__content'>
    <div class='chat-item__details'>
      <div class='chat-item__from js-chat-item-from'>Global15</div>
      <div class='chat-item__username js-chat-item-from'>@Global15</div>
      <a class='chat-item__time js-chat-time'  href='static/js/stellar23.js' title=""></a>
    </div>
    <div class='chat-item__text js-chat-item-text'>
      hi
    </div>
                ...
                <div class="chat-item model-id-5d44175f41d5cd61b59e2865 burstContinued read  " role="listitem"><div class='chat-item__container'>
    <div class="chat-item__actions js-chat-item-actions">
      <i class="chat-item__icon icon-check chat-item__icon--read js-chat-item-readby"></i>
      <i class="chat-item__icon icon-ellipsis"></i>
    </div>
